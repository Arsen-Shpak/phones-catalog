<template>
     <ul class='pagination'>
      <li 
        :class="['pagination__arrow','pagination__arrow--left',{'pagination__arrow--disable': currentPage === 1}]"
        @click="goToPrevious"
      ></li>
        <li
          v-for="page in visiblePages"
          :class="['pagination__page-link',{ 'pagination__page-link--active': currentPage === page}]"
...
export default {
    ...
    // watch: {
    //     result() {
    //         const result = this.getDefaultPoints();
    //         this.start = result[0];
    //         this.end = result[1];
    //     }
    // }
...
// @font-face {
//   font-family: 'Mont';
//   src: url('../../styles/fonts/Mont-Black.eot');
// }
